...
root = f'../{board}/'
path_svg = root + f'{board}-{layer}.svg'
path_png = root + f'{layer}-svg.png'
path_txt = root + f'{layer}.txt'
path_dist = root + f'{layer}-dist.png'
