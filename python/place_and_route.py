...
def wire_rj45_vert_lines():
    ...
    kad.wire_mod_pads([
        # 6 - GND & 8 - VCC
        ('J1', via_rj45['6'], 'J1', wire_via_rj45_row_sets[0][5], w_conn, (Dird, [(30, 1.0), 0], [(90, ctr_pwr), 135], 2), 'F.Cu'),
        ('J1', via_rj45['8'], 'J1', wire_via_rj45_row_sets[0][6], w_conn, (Dird, 0, [(90, ctr_pwr), 135], 2), 'F.Cu'),
        # Gnd - Gnd
